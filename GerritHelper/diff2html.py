...
def make_diff_html(diff_filename,diff_html_filename):
    ...
    #         encoding = a
    #     elif o in ("-i", "--input"):
    input_file = codecs.open(diff_filename, "r", encoding)
    input_file_name = diff_filename
        # elif o in ("-o", "--output"):
    output_file = codecs.open(diff_html_filename, "w")
    output_file_name = diff_html_filename
